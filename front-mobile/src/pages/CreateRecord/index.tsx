...
const BASE_URL = 'http://192.168.25.10:8080';
...
const CreateRecord =()=>{
  ...
  const handleChangePlatform = (selectedPlatform: GamePlatform)=>{
    ...
    const gameByOlatform = allGames.filter(
      game => game.platform === selectedPlatform
    )
    setFilteredGames(gameByOlatform);
  }
  ...
  useEffect(()=>{
    ...
    return(
        ...
        <View style={styles.container}>
          ...
          <TextInput style={styles.inputText} placeholder="Idade"  placeholderTextColor="#9E9E9E" keyboardType="numeric"
        ...
        Icon={()=>{
         ...
         <RectButton style ={ styles.button} onPress={handelSubmit}>
