...
const BASE_URL = 'https://sds1-heder.herokuapp.com' ;
...
useEffect(()=>{
    async function getData(){
        ...
        const  genderFormChartData = getGenderChartData(recordResponse.data.content);
        setGenderData(genderFormChartData);
    }
    getData();
